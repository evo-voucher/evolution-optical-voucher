(()=>{
  function installStyle(){
    ...
    s.textContent=`
      #initialVoucherSetup{grid-column:1/-1;display:block}
      ...
      @media(max-width:780px){#initialVoucherSetup{grid-column:auto}.partner-setup-details>summary{padding:13px 14px}.partner-setup-details-body{padding:0 10px 10px}}
    `;
