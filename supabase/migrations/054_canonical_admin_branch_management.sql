...
revoke all on function public.admin_branch_directory() from public, anon;
revoke all on function public.admin_update_branch(uuid,text,text,text,text) from public, anon;
